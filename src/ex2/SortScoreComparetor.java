...
public class SortScoreComparetor {
...
class ScoreComparator implements Comparator<Score2> {
	...
	public int compare(Score2 score1, Score2 score2) {
		if (score1.getMath() == score2.getMath()) {
			return new Integer(score2.getEnglish()).compareTo(new Integer(score1.getEnglish()));
		}
		return new Integer(score2.getMath()).compareTo(new Integer(score1.getMath()));
	}
}
